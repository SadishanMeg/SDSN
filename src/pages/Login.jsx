                ...
                <div className="space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-4 bg-gray-50 border rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 transition-all duration-200 hover:bg-gray-100 ${!isValidEmail && email
            ...
            <div className="hidden lg:flex flex-1 bg-gradient-to-br from-orange-500 to-red-500 items-center justify-center p-12">
              <div className="text-center text-white">
                ...
                <p className="text-xl opacity-90 leading-relaxed">
                  Analyze, evaluate, and bring your project ideas to life with our comprehensive feasibility assessment platform.
                </p>

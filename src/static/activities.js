...
const activities = [
  ...
  { name: "Use different emotions and ask the child to talk about a time they felt that emotion", timeTake: 18, retries: 3 },
  { name: "Advanced Role-playing: Include more complex social scenarios", timeTake: 25, retries: 2 }
];
